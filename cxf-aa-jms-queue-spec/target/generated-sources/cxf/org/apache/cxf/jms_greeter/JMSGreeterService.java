...
@WebServiceClient(name = "JMSGreeterService", 
                  wsdlLocation = "file:/D:/cxf/apache-cxf-2.2/samples/jms_queue/wsdl/jms_greeter.wsdl",
...
public class JMSGreeterService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/cxf/apache-cxf-2.2/samples/jms_queue/wsdl/jms_greeter.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/D:/cxf/apache-cxf-2.2/samples/jms_queue/wsdl/jms_greeter.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
