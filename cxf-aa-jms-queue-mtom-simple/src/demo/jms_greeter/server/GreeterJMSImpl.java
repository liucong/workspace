...
@javax.jws.WebService(portName = "GreeterPort", serviceName = "JMSGreeterService", targetNamespace = "http://cxf.apache.org/jms_greeter", endpointInterface = "org.apache.cxf.jms_greeter.JMSGreeterPortType", wsdlLocation = "file:./wsdl/jms_greeter.wsdl")
public class GreeterJMSImpl implements JMSGreeterPortType {
    ...
    public void testDataHandler(Holder<String> name, Holder<DataHandler> attachinfo) {
        LOG.info("Executing operation DataHandler");
        ...
        System.out.println("TestDataHandler");
    }
}
